...
const GROUPS = [
  ...
  { icon: GitBranch, name: "GitOps & CI/CD", items: ["ArgoCD", "Argo Rollouts", "GitHub Actions", "Argo Workflows"] },
  { icon: Activity, name: "Observability", items: ["Prometheus", "Grafana", "Loki", "OpenTelemetry", "Jaeger"] },
  { icon: ShieldCheck, name: "Security", items: ["Trivy", "Gitleaks", "Vault", "Checkov", "OPA", "Sonarcode"] },
  { icon: Brain, name: "MLOps", items: ["MLflow", "DVC", "KServe", "FastAPI", "Kubeflow"] },
  { icon: Zap, name: "Languages", items: ["Python", "Bash", "HCL", "YAML", "C", "C++", "Java"] },
];
const RELATED = {
  ...
  "MLflow": ["DVC", "KServe", "FastAPI", "Kubeflow"],
  "Trivy": ["Gitleaks", "Vault", "Checkov", "OPA", "Sonarcode"],
