...
function RoleCycler() {
    const roles = ["Cloud Engineer", "DevOps Engineer", "SRE", "MLOps Engineer", "Platform Engineer"];
        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[1.35fr_1fr] lg:gap-16">
          ...
          <motion.div variants={stagger} initial="hidden" animate="show" className="flex flex-col items-start gap-6">
            ...
            <motion.div variants={fade} className="flex flex-wrap items-center gap-3 pt-1">
              ...
              <a href="#contact" className="group inline-flex items-center gap-2 rounded-full bg-transparent px-5 py-3 text-sm font-medium text-muted-foreground transition hover:text-foreground">
                <FileText className="h-4 w-4"/> Contact
