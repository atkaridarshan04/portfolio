...
export function Certifications() {
    const certs = [
        { name: "AWS Certified Solutions Architect — Associate", issuer: "Amazon Web Services", year: "2025", url: "#" },
        { name: "Certified Kubernetes Administrator (CKA)", issuer: "CNCF / Linux Foundation", year: "2025", url: "#" },
        { name: "HashiCorp Certified: Terraform Associate", issuer: "HashiCorp", year: "2024", url: "#" },
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-12">
          ...
          <div className="md:col-span-8">
            <ul className="space-y-3">
              {certs.map((c, i) => (<motion.li key={c.name} initial={{ opacity: 0, x: -12 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: i * 0.06 }}>
                  <a href={c.url} className="group flex items-center gap-4 rounded-2xl hairline bg-surface/60 px-5 py-4 transition hover:bg-surface-elevated hover:ring-1 hover:ring-primary/30">
